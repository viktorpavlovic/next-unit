...
const Product = ({ icon, title, description }: Props) => {
  return (
    <motion.div
      variants={childVariant}
      className="mt-5 w-full sm:w-72 sm:h-96 md:w-80 md:h-[400px] lg:w-96 lg:h-[450px] rounded-md border-2 border-gray-100 px-5 py-8 text-center overflow-y-auto"
    >
